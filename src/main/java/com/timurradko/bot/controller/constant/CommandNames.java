...
public interface CommandNames {
    ...
    String SHOW_ALL_COURSES = "/show_all_courses";
    ...
    String ADD_NEW_COURSE = "/add_new_course";
    String ADMIN_CHANGE_COURSE = "/admin_change_course";
    String EDIT_COURSE = "/edit_course";
    String DELETE_COURSE = "/delete_course";
    String CHANGE_PARAMETERS_COURSE = "/change_parameters_course";
    String READ_COURSE_TITLE = "/read_course_title";
    String READ_COURSE_DESCRIPTION = "/read_course_description";
    String ADD_INFO_ABOUT_COURSE = "/add_info_about_course";
    String CHOOSE_COURSE_ACTION = "/choose_course_action";
    String SELECT_COURSE_TO_DELETE = "/select_course_to_delete";
